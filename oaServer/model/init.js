const db = require('../utils/database.js'); // 初始化数据库表信息
const fs = require('fs');
...
let users = db.model("users",{ // 用户
    ...
    nickname: { type: String, default: 'dibai-' + Date.now()},
    email: { type: String, default: '' },
    phone: { type: String, default: '' },
    sex: { type: String, default: '3' }, // 0 男 1 女 3 保密
    bubble: { type: String, default: 'dibai' }, // 气泡
    chatTheme: { type: String, default: 'dibai' }, // 聊天主题
    projectTheme: { type: String, default: 'dibai' }, // 项目主题
    wallpaper: { type: String, default: 'dibai' }, // 聊天壁纸
