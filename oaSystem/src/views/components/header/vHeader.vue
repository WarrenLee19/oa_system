                    ...
                    <nav class="vchat-noUser">
                        ...
                        <div>
                            <el-badge :value="unReadCount" :max="99" :hidden="unReadCount === 0" class="headerBadg">
                                <span class="nav-btn" @click="showChat = !showChat">发消息</span>
                            </el-badge>
...
//                hover: false,
        ...
        watch: {
            showChat() {
                this.x = Number(window.localStorage.x) || 0;
                this.y = Number(window.localStorage.y) || 150;
        ...
        methods: {
            reset() {
                ...
                this.w = 126;
                this.h = 60;
                window.localStorage.w = 156;
                window.localStorage.h = 80;
                window.localStorage.x = 0;
                window.localStorage.y = 150;
            },
            loginOut() {
                this.leaveRoom();
                api.loginOut().then(r => {
