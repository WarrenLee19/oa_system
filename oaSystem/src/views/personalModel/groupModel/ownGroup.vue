<template>
    <div class="vchat-ownGroup vchat-noUser" style="width:26rem">
        <v-apheader title="我的群聊">
            <el-dropdown trigger="click" @command="handleCommand">
                <v-icon cursor="pointer" name="hanbaobao" color="blue"></v-icon>
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="/group/set">新建群聊</el-dropdown-item>
                    <el-dropdown-item command="/group/search">查找群聊</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        </v-apheader>
