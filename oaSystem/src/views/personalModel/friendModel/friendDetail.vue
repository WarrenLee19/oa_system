<template>
    <div class="vchat-Detail" style="width:26rem">
        ...
        <div class="vchat-Detail-container friend-detail-container">
            ...
            <div  v-if="friendInfo.code !== user.code">
                <button @click="apply" class="vchat-full-button minor" v-if="!myFriendFlag">加为好友</button>
                 <button @click="remove" class="vchat-full-button danger" style="width:80px" v-else>删好友</button>
                
            </div>
            <div> <vHeader></vHeader>   </div>
        </div>
