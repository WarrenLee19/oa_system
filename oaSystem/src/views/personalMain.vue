<template>
    <div class="oa-myFriend oa-noUser">
       
        <v-apheader title="我的好友">
            <el-dropdown trigger="click" @command="handleCommand">
                <v-icon cursor="pointer" name="jia" color="blue"></v-icon>
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="/searchFriend" >添加好友</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        </v-apheader>
        <div class="oa-myFriend-container">
            ...
            <v-nodata v-else>
                <p class="vchat-no-have">
                    还没有添加好友，快去 <router-link to="/searchFriend">添加</router-link>。
                    </p>
            </v-nodata>
        </div>
