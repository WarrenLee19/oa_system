<template>
    <el-dialog :title="logTitle" :visible.sync="dialogVisible" @close="close">
        <el-form :model="todoForm" ref="todoForm">
            <el-form-item label="日程主题" label-width="100px" prop="title" :rules="[{ required: true, message: '主题不能为空'}]">
                <el-input v-model="todoForm.title"></el-input>
            </el-form-item>
            <el-form-item label="日程内容" label-width="100px" prop="content" :rules="[{ required: true, message: '内容不能为空'}]">
                <el-input type="textarea" v-model="todoForm.content" resize="none"></el-input>
            </el-form-item>
            <el-form-item label="日程地点" label-width="100px">
