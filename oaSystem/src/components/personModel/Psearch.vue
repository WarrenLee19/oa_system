<template>
    <div class="vchat-searchGroup">
        <v-apheader title="查找好友" back="/main/personalMain/group/own"></v-apheader>
        <div class="vchat-search group-search">
            <el-select v-model="type" placeholder="请选择搜索方式" @change="huntGroups" style="width:26%">
                <el-option
...
<script>
    // import api from '@/api';
    import vApheader from '@/components/components/vApheader';
    export default{
        name: 'searchGroup',
        data() {
            return {
